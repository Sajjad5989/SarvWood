...
//                    // inja mifahmim success boode ya na
...
//    }
//
//    public void changeCustomerPassword(int userId, String token, ChangeCustomerPasswordBody body, IResponseListener listener ){
//        processResponseBody( apiInterface.changeCustomerPassword(userId,token, body ), listener );
//    }
//
...
//    }
//
//   // public void insrtCustomerSimple( InsrtCustomerSimpleBody body, UserView listener ){
...
//        processResponseBody( apiInterface.getOrderDetails( userId, token, body ), listener );
//    }
//
//    public void getOrderDiscardOptions( int userId, String token, DiscardOrderBody body, IResponseListener listener ){
//        processResponseBody( apiInterface.discardOrder( userId, token,body ), listener );
//    }
//
